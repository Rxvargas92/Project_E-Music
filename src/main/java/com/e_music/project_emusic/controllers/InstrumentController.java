...
public class InstrumentController extends BaseControllerImpl< Instrument, ServiceInstrumentImpl >{
    ...
    @GetMapping (value = "/list/details/{id}")
    public ModelAndView details(Model model, @PathVariable("id") long id ){
        ModelAndView modelAndView = new ModelAndView();
        try {
    ...
    public ModelAndView editInstrument(@PathVariable("id")long id){
        ...
        try {
            ...
            modelAndView.addObject("categories",this.serviceCategory.findAll());
            modelAndView.addObject("brands",this.serviceBrand.findAll());
...
/*
    ...
    public ModelAndView listInstrument(Model model, @PathVariable("id") long id ) {
        ModelAndView modelAndView = new ModelAndView();
        try {
